...
class Model:
    ...
    def __init__(
        ...
        logging.info("Initializing sentencepiece model for SRC and TGT")
        ...
        logging.info("Initializing model for translation")
        # initialize the model
        if model_type == "ctranslate2":
            import ctranslate2

            self.translator = ctranslate2.Translator(
                self.ckpt_dir, device=device, device_index=device_index,
            )  # , compute_type="auto")
